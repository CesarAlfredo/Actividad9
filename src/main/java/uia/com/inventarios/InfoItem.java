...
public class InfoItem {
    ...
    private CondicionApartado condicionApartado = new CondicionApartado();
    ...
    public InfoItem(String idItem, String descCat, String sinEstatus, String s, String ubic,String condicion)
    {
        this.id = idItem;
        this.name = descCat;
        this.estatus = sinEstatus;
        ubicacion.setPosicion(ubic);
        condicionApartado.setConficionFisicaApartado(condicion);
    }
