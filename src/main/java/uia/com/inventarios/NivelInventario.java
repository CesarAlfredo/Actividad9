...
public class NivelInventario extends PartidaInventario{
    ...
    public void agrega(String idPartida, String descPartida, String idSubpartida, String descSubpartida, String idCat, String descCat, String cantidad,String condicion)
    {
            ...
            if (this.getItems().get(idPartida).getItems().get(idSubpartida) != null)
            {
                if (this.getItems().get(idPartida).getItems().get(idSubpartida).getItems().get(idCat) == null)
                {
                    ...
                    for(int i=0; i<Integer.parseInt(cantidad); i++)
                    {
                        ...
                        InfoItem item = new InfoItem(idItem, descCat, "SinEstatus", "1", ubic,condicion);
